...
function consultaSaldo() {
  ...
  console.log(chalk.bgYellow.white(`Saldo disponível na conta: ${saldoUsuario.saldo}`));
...
function deposita() {
  ...
  inquirer
      ...
      .then((value) => {
          ...
          console.log(chalk.bgYellow.white(`Depósito realizado com sucesso!`));
          dashboard();
      })
}
...
function saca() {
  ...
  inquirer
      ...
      .then((value) => {
          ...
          fs.writeFileSync(caminhoUsuario, JSON.stringify(saldoUsuario));
          console.log(chalk.bgYellow.white(`Saque realizado com sucesso!`));
          dashboard();
      })
